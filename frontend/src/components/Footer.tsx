...
export function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-900 via-gray-900 to-black text-white pt-10 pb-6 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-2 mb-4">
              <a
                href="#"
                className="w-10 h-10 bg-gradient-to-br from-red-600 to-red-700 rounded-lg flex items-center justify-center hover:from-red-700 hover:to-red-800 transition-all duration-300 transform hover:scale-110"
                aria-label="Facebook"
              >
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-gray-300">
                ...
                <span className="text-sm">+977 98-00000000</span>
              </div>
              <div className="flex items-center gap-3 text-gray-300">
                <Mail className="w-5 h-5 text-red-500" />
                <span className="text-sm">info@showsewa.com</span>
              </div>
              <div className="flex items-center gap-3 text-gray-300">
              ...
              {quickLinks.map(link => (
                <li key={link.id}>
                  <button
                    ...
                    className="text-gray-300 hover:text-red-500 hover:translate-x-2 transition-all duration-300 flex items-center gap-2 group"
                  >
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-3 rounded-lg border border-gray-700 hover:border-red-600 transition-all duration-300">
